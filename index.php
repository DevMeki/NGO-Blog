...
<head>
  ...
  <style>
    /* Professional Typewriter Cursor */
    .typing-cursor {
    ...
    /* Fixed height for typing container to prevent layout shifting */
    .typing-container {
      display: inline-flex;
      align-items: center;
      min-height: 1.2em;
...
<body class="text-gray-950 bg-gray-100">
  ...
  <div class="bg-gray-100 min-h-screen font-sans">
    ...
    <div data-alt="Abstract gradient background" class="relative bg-cover bg-center bg-no-repeat">
      ...
      <div
        ...
        <section class="flex flex-col lg:flex-row justify-between items-center w-full max-w-6xl z-10">
          <div class="max-w-xl text-center lg:text-left mb-12 lg:mb-0">
            <h1 class="text-4xl sm:text-6xl font-extrabold leading-tight fade-in-left">
              ...
              <span class="typing-container">
                <span class="typing-text" data-phrases='["YOUTHS (CINY)"]'></span>
          ...
          <div
            ...
            <img src="Assets/img/logo bg.png" alt="CINY Logo"
              class="w-full h-full object-contain p-4 animate-spin-45" />
          </div>
        </section>

        <div class="absolute bottom-6 w-full flex justify-center fade-in-up stagger-delay-2">
    ...
    <div class="background-image: linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.6) 100%), url(Assets/img/xmas bg mobile.jpg') md:[background-image:linear-gradient(rgba(0,0,0,0.4)_0%,rgba(0,0,0,0.6)_100%),url('Assets/img/xmas bg desktop.png')] bg-cover bg-center bg-no-repeat
        ...
        <div class="@container">
          <div class="@[480px]:p-4">
            <div
              ...
              data-alt="Abstract gradient background" style=' background-image: linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.6) 100%),
      url("Assets/img/Cover 2.jpg")'>
