...
<body class="text-gray-950 bg-gray-100">
  ...
  <div class="bg-gray-100 min-h-screen font-sans">
    ...
    <div data-alt="Abstract gradient background" class="relative bg-cover bg-center bg-no-repeat">
      ...
      <!-- Mobile background -->
      <div class="md:hidden absolute inset-0 bg-cover bg-center  relative min-h-screen flex flex-col justify-center items-center py-10 px-6 sm:px-10 overflow-hidden text-white"
      ...
      <!-- Desktop background -->
      <div class="hidden md:block absolute inset-0 bg-cover bg-center  relative min-h-screen flex flex-col justify-center items-center py-10 px-6 sm:px-10 overflow-hidden text-white"
    ...
    <div
      class="background-image: linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.6) 100%), url(Assets/img/xmas bg mobile.jpg') md:[background-image:linear-gradient(rgba(0,0,0,0.4)_0%,rgba(0,0,0,0.6)_100%),url('Assets/img/xmas bg desktop.png')] bg-cover bg-center bg-no-repeat
        ...
        <div class="@container">
          <div class="@[480px]:p-4">
            <div
              ...
              data-alt="Abstract gradient background"
              style=' background-image: linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.6) 100%),
