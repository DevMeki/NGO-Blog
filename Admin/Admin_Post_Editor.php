                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select id="categories_select"
                                        ...
                                        <option value="Product Updates" <?php echo ($Categories == 'CINY') ? 'selected' : ''; ?>>CINY News</option>
                                        <option value="Company News" <?php echo ($Categories == 'OTHERS') ? 'selected' : ''; ?>>OTHERS</option>
                                    </select>
                                </div>
                                <div>
