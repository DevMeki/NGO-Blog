...
<div
    ...
    <!-- Mobile Menu Toggle -->
    <button id="mobileMenuToggle" class="lg:hidden absolute -right-12 top-4 p-2 bg-white dark:bg-[#1a2633] rounded-r-lg border border-l-0 border-gray-200 dark:border-gray-700">
...
<!-- Confirmation Modal -->
<div id="logoutModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 dark:bg-opacity-80 items-center justify-center z-50 p-4">
